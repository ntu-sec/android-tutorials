...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new MyAdapter(this, favoriteTWShows);
//        ListAdapter adapter = new ArrayAdapter<>(this, R.layout.row_layout, R.id.textView1, favoriteTWShows);
